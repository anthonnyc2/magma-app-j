...
<div data-role="header" data-id="categorias-header" id="categorias-header" data-position="fixed">
	...
	<a class="magma_logo" href="#home"><img src="images/navigation/magma_logo.png" alt=""></a>
		...
		<div class="barra_titulo_seccion"><div class="date"><%= fecha %></div><div class="titulo_seccion"><%= favoritos_title %></div></div>
</div>
<!-- FIN: HOME - header -->
...
<!-- HOME - content -->
<div data-role="content" id="favoritos-content">
</div>
<!-- FIN: HOME - content -->
...
<div data-role="footer" data-id="home-footer" id="home-footer" data-position="fixed">
	<div data-role="navbar" data-iconpos="top">
		<ul>
			...
			<li>
				<a href="#favoritos" class="ui-btn-active ui-state-persist" data-transition="slide" data-theme="" data-icon="gear"><%= home_navbar_favoritos %></a>
			</li>
